...
from commerce.controllers import products_controller, category_controllers, vendor_controller, order_controller,checkout_controller
...
api.add_router('category', category_controllers)
